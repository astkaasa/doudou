...
export const NEWS_POOL = {
  ...
  entertainment: [
    {title:'世界杯带动举办地客流增长',desc:'本届赛事开赛前后，举办城市住宿和机票预订走高，航空公司加开包机。',effect:'相关航线需求激增25%',years:WORLD_CUP_YEARS,quarters:[2,3],stockEffect:{culture:0.04,tourism:0.06},effectFn:({state:G,addDemandModifier})=>{addDemandModifier(G,'世界杯客流高峰',scopeAll(),1.25);}},
