...
const CITY_ERA_DATA = {
  ...
  osaka: [[2.0,38,20], [2.3,50,28], [2.7,58,32]],
  ...
  seville: [[0.5,18,40], [0.6,22,48], [0.7,28,52]],
  hannover: [[0.4,30,10], [0.5,35,12], [0.5,38,15]],
  milan: [[1.0,42,22], [1.1,50,28], [1.3,58,35]],
  ...
  montreal: [[1.4,42,28], [1.6,50,32], [1.7,55,35]],
  ...
  // ===== 南美洲 =====
  rio: [[3.2,18,30], [5.5,28,42], [6.7,35,55]],
